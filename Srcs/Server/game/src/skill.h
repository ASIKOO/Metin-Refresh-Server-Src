...
enum ESkillIndexes
{
	...
	SKILL_P_PALBANG = 221,
	SKILL_P_AMSEUP	= 222,
	SKILL_P_SWAERYEONG = 223,
	SKILL_P_YONGPA = 224,
	SKILL_P_GIGONGCHAM = 225,
	SKILL_P_HWAJO = 226,
	SKILL_P_MARYEONG = 227,
	SKILL_P_BYEORAK = 228,
	SKILL_P_SALPOONG = 229,
	
	// 8ème skill
	SKILL_PP_PALBANG = 236,
	SKILL_PP_AMSEUP = 237,
	SKILL_PP_SWAERYEONG = 238,
	SKILL_PP_YONGPA = 239,
	SKILL_PP_GIGONGCHAM = 240,
	SKILL_PP_HWAJO = 241,
	SKILL_PP_MARYEONG = 242,
	SKILL_PP_BYEORAK = 243,
	SKILL_PP_SALPOONG = 244,
};
...
class CSkillProto
{
	public:
		...
		DWORD	dwType;			// 0: ÀüÁ÷¾÷, 1: ¹«»ç, 2: ÀÚ°´, 3: ¼ö¶ó, 4: ¹«´ç, 5: ¸ð¸§, 6: ¸ð¸§, 7: ¼öÀÎÁ·
