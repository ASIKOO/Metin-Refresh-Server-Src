...
bool CHARACTER::IsLearnableSkill(DWORD dwSkillVnum) const
{
	...
	if (6 == pkSkill->dwType)
	{
		...
		if (dwSkillVnum >= SKILL_P_PALBANG && dwSkillVnum <= SKILL_P_SALPOONG) // 7ème skill
		{
			return true;
		}
		else if (dwSkillVnum >= SKILL_PP_PALBANG && dwSkillVnum <= SKILL_PP_SALPOONG) // 8ème skill
		{
			return true;
		}
...
void CHARACTER::SkillLevelUp(DWORD dwVnum, BYTE bMethod)
{
	...
	//srand(time(0));
	//int randomLevelMasterUpgrade = rand() % 20 + 17;
...
struct FuncSplashDamage
{
	...
	void operator () (LPENTITY ent)
	{
		...
		switch (m_pkSk->bSkillAttrType)
		{
			...
			case SKILL_ATTR_TYPE_MELEE:
				{
					...
					{
						int skillParade = pkChrVictim->Get7emeSkill(); // Skill de parade ennemie.
						int skillBonus = m_pkChr->Get8emeSkill(); // Skill de bonus.

						int skillValeurParade = (int) (0.1f * (pkChrVictim->GetSkillLevel(skillParade)*24)); // Récupère le %
						int skillValeurBonus = (int) (0.1f *(m_pkChr->GetSkillLevel(skillBonus)*16)); // Récupère le %

					
						switch(m_pkSk->dwVnum) // Nouveaux skill parade/bonus pour skill physique
						{
							case 2: // En cas de moulinet à l'épée.
							{
								int coef = 0;
								if (skillParade == 221 && skillBonus == 236) // si le skill de parade et de bonus sont identique.
								{
									if (skillValeurBonus > skillValeurParade)
									{
										coef = skillValeurBonus - skillValeurParade; // soustraction des deux bonus.
										iDam += ((iDam * coef) / 100); // ajoute le pourcentage aux dégats.
									}
									if (skillValeurParade > skillValeurBonus)
									{
										coef = skillValeurParade - skillValeurBonus; // soustraction des deux bonus.
										iDam -= ((iDam * coef) / 100); // soustrait le pourcentage aux dégats.
									}
								}
								else if (skillParade == 221 && skillBonus != 236) // si le joueur ne possède aucun bonus.
								{
									coef = skillValeurParade;
									iDam -= ((iDam * coef) / 100); // soustrait le pourcentage aux dégats.
								}
								else if (skillParade != 221 && skillBonus == 236)
								{
									coef = skillValeurBonus;
									iDam += ((iDam * coef) / 100); // ajoute le pourcentage aux dégats.
								}
							}
							break;
							case 31: // En cas d'embuscade.
							{
								int coef = 0;
								if (skillParade == 222 && skillBonus == 237) // si le skill de parade et de bonus sont identique.
								{
									if (skillValeurBonus > skillValeurParade)
									{
										coef = skillValeurBonus - skillValeurParade; // soustraction des deux bonus.
								...
								else if (skillParade == 222 && skillBonus != 237) // si le joueur ne possède aucun bonus.
								{
									coef = skillValeurParade;
									iDam -= ((iDam * coef) / 100); // soustrait le pourcentage aux dégats.
								}
								else if (skillParade != 222 && skillBonus == 237)
								{
									coef = skillValeurBonus;
									iDam += ((iDam * coef) / 100); // ajoute le pourcentage aux dégats.
								}
							...
							break;
							case 61: // En cas de toucher brulant.
							{
								int coef = 0;
								if (skillParade == 223 && skillBonus == 238) // si le skill de parade et de bonus sont identique.
								{
									if (skillValeurBonus > skillValeurParade)
									{
										coef = skillValeurBonus - skillValeurParade; // soustraction des deux bonus.
								...
								else if (skillParade == 223 && skillBonus != 238) // si le joueur ne possède aucun bonus.
								{
									coef = skillValeurParade;
									iDam -= ((iDam * coef) / 100); // soustrait le pourcentage aux dégats.
								}
								else if (skillParade != 223 && skillBonus == 238)
								{
									coef = skillValeurBonus;
									iDam += ((iDam * coef) / 100); // ajoute le pourcentage aux dégats.
								}
							...
							break;
							case 171: // En cas de souffle de loup.
							{
								int coef = 0;
								if (skillParade == 229 && skillBonus == 244) // si le skill de parade et de bonus sont identique.
								{
									if (skillValeurBonus > skillValeurParade)
									{
										coef = skillValeurBonus - skillValeurParade; // soustraction des deux bonus.
								...
								else if (skillParade == 229 && skillBonus != 244) // si le joueur ne possède aucun bonus.
								{
									coef = skillValeurParade;
									iDam -= ((iDam * coef) / 100); // soustrait le pourcentage aux dégats.
								}
								else if (skillParade != 229 && skillBonus == 244)
								{
									coef = skillValeurBonus;
									iDam += ((iDam * coef) / 100); // ajoute le pourcentage aux dégats.
								}
							...
							break;
							case 16: // En cas d'attaque de l'esprit.
							{
								int coef = 0;
								if (skillParade == 225 && skillBonus == 240) // si le skill de parade et de bonus sont identique.
								{
									if (skillValeurBonus > skillValeurParade)
									{
										coef = skillValeurBonus - skillValeurParade; // soustraction des deux bonus.
								...
								else if (skillParade == 225 && skillBonus != 240) // si le joueur ne possède aucun bonus.
								{
									coef = skillValeurParade;
									iDam -= ((iDam * coef) / 100); // soustrait le pourcentage aux dégats.
								}
								else if (skillParade != 225 && skillBonus == 240)
								{
									coef = skillValeurBonus;
									iDam += ((iDam * coef) / 100); // ajoute le pourcentage aux dégats.
								}
			...
			case SKILL_ATTR_TYPE_RANGE:
			{
				...
				if (SYSTEM_NOUVEAU_SKILL_7ET8 > 0)
				{
					...
					switch(m_pkSk->dwVnum) // Nouveaux skill parade/bonus pour skill de flèche
					{
						case 48: // En cas de flèche de feu
						{
							int coef = 0;
							if (skillParade == 226 && skillBonus == 241) // si le skill de parade et de bonus sont identique.
							{
								if (skillValeurBonus > skillValeurParade)
								{
									coef = skillValeurBonus - skillValeurParade; // soustraction des deux bonus.
							...
							else if (skillParade == 226 && skillBonus != 241) // si le joueur ne possède aucun bonus.
							{
								coef = skillValeurParade;
								iDam -= ((iDam * coef) / 100); // soustrait le pourcentage aux dégats.
							}
							else if (skillParade != 226 && skillBonus == 241)
							{
								coef = skillValeurBonus;
								iDam += ((iDam * coef) / 100); // ajoute le pourcentage aux dégats.
							}
			...
			case SKILL_ATTR_TYPE_MAGIC:
			{
				...
				int defMagie;
				defMagie = 0;
				if (pkChrVictim->GetPoint(POINT_RESIST_MAGIC) > 90)
				{
				...
				{
					defMagie = pkChrVictim->GetPoint(POINT_RESIST_MAGIC);
				}
				if (m_pkChr->GetPoint(POINT_RESIST_MAGIC_REDUCTION) > 0) // Si le joueur possède de l'anti-magie.
				{
					if (m_pkChr->GetRaceNum() == 2 || m_pkChr->GetRaceNum() == 6) // Si le personnage est un sura l'effet d'anti-magie qu'il possède est divisé par deux
					{

						
						iDam = iDam * ( ( 100 - defMagie ) +  ( m_pkChr->GetPoint(POINT_RESIST_MAGIC_REDUCTION) / 2 ) ) / 100;							
						
					}
					else // Si le personnage n'est pas un Sura.
					{

						iDam = iDam * ( ( 100 - defMagie ) + m_pkChr->GetPoint(POINT_RESIST_MAGIC_REDUCTION) ) / 100;
						

					}
				}
				else  // Sinon si le joueur ne possède pas d'anti-magie.

				{
					
					iDam = iDam * (100 - defMagie) / 100;
				...
				if (SYSTEM_NOUVEAU_SKILL_7ET8 > 0)
				{
					...
					switch(m_pkSk->dwVnum) // Nouveaux skill parade/bonus pour skill magique
					{
						
						case 92: // En cas de dragon chassant.
						{
							int coef = 0;
							if (skillParade == 224 && skillBonus == 239) // si le skill de parade et de bonus sont identique.
							{
								if (skillValeurBonus > skillValeurParade)
								{
									coef = skillValeurBonus - skillValeurParade; // soustraction des deux bonus.
							...
							else if (skillParade == 224 && skillBonus != 239) // si le joueur ne possède aucun bonus.
							{
								coef = skillValeurParade;
								iDam -= ((iDam * coef) / 100); // soustrait le pourcentage aux dégats.
							}
							else if (skillParade != 224 && skillBonus == 239)
							{
								coef = skillValeurBonus;
								iDam += ((iDam * coef) / 100); // ajoute le pourcentage aux dégats.
							}
						...
						break;
						case 76: // En cas d'attaque des ténèbres.
						{
							int coef = 0;
							if (skillParade == 227 && skillBonus == 242) // si le skill de parade et de bonus sont identique.
							{
								if (skillValeurBonus > skillValeurParade)
								{
									coef = skillValeurBonus - skillValeurParade; // soustraction des deux bonus.
							...
							else if (skillParade == 227 && skillBonus != 242) // si le joueur ne possède aucun bonus.
							{
								coef = skillValeurParade;
								iDam -= ((iDam * coef) / 100); // soustrait le pourcentage aux dégats.
							}
							else if (skillParade != 227 && skillBonus == 242)
							{
								coef = skillValeurBonus;
								iDam += ((iDam * coef) / 100); // ajoute le pourcentage aux dégats.
							}
						...
						break;
						case 107: // En cas d'invocation de foudre.
						{
							int coef = 0;
							if (skillParade == 228 && skillBonus == 243) // si le skill de parade et de bonus sont identique.
							{
								if (skillValeurBonus > skillValeurParade)
								{
									coef = skillValeurBonus - skillValeurParade; // soustraction des deux bonus.
							...
							else if (skillParade == 228 && skillBonus != 243) // si le joueur ne possède aucun bonus.
							{
								coef = skillValeurParade;
								iDam -= ((iDam * coef) / 100); // soustrait le pourcentage aux dégats.
							}
							else if (skillParade != 228 && skillBonus == 243)
							{
								coef = skillValeurBonus;
								iDam += ((iDam * coef) / 100); // ajoute le pourcentage aux dégats.
							}
		...
		//
		// 20091109 ?? ?? ?? ?? ??
		// ?? ?? ???? SKILL_FLAG_WIND, SKILL_FLAG_ELEC, SKILL_FLAG_FIRE? ?? ???
		// ?? ????? ???? RESIST_WIND, RESIST_ELEC, RESIST_FIRE? ???? ?? ???.
		//
		// PvP? PvE??? ??? ?? ????? NPC? ????? ??? ?? ???? ????
		// ??? ??? ?? mob_proto? RESIST_MAGIC? RESIST_WIND, RESIST_ELEC, RESIST_FIRE?
		// ?????.
		//
...
bool CHARACTER::UseSkill(DWORD dwVnum, LPCHARACTER pkVictim, bool bUseGrandMaster) // Grup Kutsama Sistemi
{
	...
	if ((dwVnum == SKILL_HOSIN || dwVnum == SKILL_REFLECT || dwVnum == SKILL_GICHEON || dwVnum == SKILL_JEONGEOP || dwVnum == SKILL_KWAESOK || dwVnum == SKILL_JEUNGRYEOK) && GetParty())
	{
		ComputeSkillParty(dwVnum, this);
	}
	else if ((dwVnum == SKILL_HOSIN || dwVnum == SKILL_REFLECT || dwVnum == SKILL_GICHEON || dwVnum == SKILL_JEONGEOP || dwVnum == SKILL_KWAESOK || dwVnum == SKILL_JEUNGRYEOK) && !GetParty())
	{
        	ComputeSkill(dwVnum, pkVictim);
	}
...
bool CHARACTER::IsUsableSkillMotion(DWORD dwMotionIndex)
{
	DWORD selfJobGroup = (GetJob() + 1) * 10 + GetSkillGroup();

	const DWORD SKILL_NUM = 245;
	static DWORD s_anSkill2JobGroup[SKILL_NUM] = {
		...
		0, // empty 219
		0, // empty 220
		0, // job_skill (PASSIVE_SKILL) 221
		0, // job_skill (PASSIVE_SKILL) 222
		0, // job_skill (PASSIVE_SKILL) 223
		0, // job_skill (PASSIVE_SKILL) 224
		0, // job_skill (PASSIVE_SKILL) 225
		0, // job_skill (PASSIVE_SKILL) 226
		0, // job_skill (PASSIVE_SKILL) 227
		0, // job_skill (PASSIVE_SKILL) 228
		0, // job_skill (PASSIVE_SKILL) 229
		0, // empty 230
		0, // empty 231
		0, // empty 232
		0, // empty 233
		0, // empty 234
		0, // empty 235
		0, // job_skill (PASSIVE_SKILL) 236
		0, // job_skill (PASSIVE_SKILL) 237
		0, // job_skill (PASSIVE_SKILL) 238
		0, // job_skill (PASSIVE_SKILL) 239
		0, // job_skill (PASSIVE_SKILL) 240
		0, // job_skill (PASSIVE_SKILL) 241
		0, // job_skill (PASSIVE_SKILL) 242
		0, // job_skill (PASSIVE_SKILL) 243
		0, // job_skill (PASSIVE_SKILL) 244
	};

	const DWORD MOTION_MAX_NUM = 124;
	const DWORD SKILL_LIST_MAX_COUNT = 24;

	static DWORD s_anMotion2SkillVnumList[MOTION_MAX_NUM][SKILL_LIST_MAX_COUNT] =
	{
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  0
		{ 5, 1, 31, 61, 91, 170, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  1
		{ 5, 2, 32, 62, 92, 171, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  2
		{ 5, 3, 33, 63, 93, 172, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  3
		{ 5, 4, 34, 64, 94, 173, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  4
		{ 5, 5, 35, 65, 95, 174, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  5
		{ 5, 6, 36, 66, 96, 175, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  6
		{ 0, 0, 0, 0, 0, 0, 0, }, //  10
		{ 0, 0, 0, 0, 0, 0, 0, }, //  10
		{ 0, 0, 0, 0, 0, 0, 0, }, //  10
		{ 0, 0, 0, 0, 0, 0, 0, }, //  10
		...
		{ 0, 0, 0, 0, 0, 0, 0, }, //  14
		{ 0, 0, 0, 0, 0, 0, 0, }, //  15
		{ 4, 16, 46, 76, 106, 170, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  16
		{ 4, 17, 47, 77, 107, 171, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  17
		{ 4, 18, 48, 78, 108, 172, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  18
		{ 4, 19, 49, 79, 109, 173, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  19
		{ 4, 20, 50, 80, 110, 174, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  20
		{ 4, 21, 51, 81, 111, 175, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  21
		{ 0, 0, 0, 0, 0, 0, 0, }, //  25
		{ 0, 0, 0, 0, 0, 0, 0, }, //  25
		{ 0, 0, 0, 0, 0, 0, 0, }, //  25
		{ 0, 0, 0, 0, 0, 0, 0, }, //  25
		{ 5, 1, 31, 61, 91, 170, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  26
		{ 5, 2, 32, 62, 92, 171, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  27
		{ 5, 3, 33, 63, 93, 172, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  28
		{ 5, 4, 34, 64, 94, 173, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  29
		{ 5, 5, 35, 65, 95, 174, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  30
		{ 5, 6, 36, 66, 96, 175, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  31
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  35
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  35
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  35
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  35
		...
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  39
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  40
		{ 4, 16, 46, 76, 106, 170, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  41
		{ 4, 17, 47, 77, 107, 171, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  42
		{ 4, 18, 48, 78, 108, 172, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  43
		{ 4, 19, 49, 79, 109, 173, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  44
		{ 4, 20, 50, 80, 110, 174, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  45
		{ 4, 21, 51, 81, 111, 175, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  46
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  35
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  35
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  35
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  50
		{ 5, 1, 31, 61, 91, 170, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  51
		{ 5, 2, 32, 62, 92, 171, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  52
		{ 5, 3, 33, 63, 93, 172, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  53
		{ 5, 4, 34, 64, 94, 173, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  54
		{ 5, 5, 35, 65, 95, 174, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  55
		{ 5, 6, 36, 66, 96, 175, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  56
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  60
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  60
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  60
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  60
		...
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  64
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  65
		{ 4, 16, 46, 76, 106, 170, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  66
		{ 4, 17, 47, 77, 107, 171, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  67
		{ 4, 18, 48, 78, 108, 172, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  68
		{ 4, 19, 49, 79, 109, 173, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  69
		{ 4, 20, 50, 80, 110, 174, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  70
		{ 4, 21, 51, 81, 111, 175, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  71
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  75
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  75
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  75
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  75
		{ 5, 1, 31, 61, 91, 170, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  76
		{ 5, 2, 32, 62, 92, 171, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  77
		{ 5, 3, 33, 63, 93, 172, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  78
		{ 5, 4, 34, 64, 94, 173, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  79
		{ 5, 5, 35, 65, 95, 174, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  80
		{ 5, 6, 36, 66, 96, 175, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  81
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  75
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  75
		{ 0, 0, 0, 0, 0, 0, 0, 0, }, //  75
		{ 0, 0, 0, 0, 0, 0, 0, }, //  85
		...
		{ 0, 0, 0, 0, 0, 0, 0, }, //  89
		{ 0, 0, 0, 0, 0, 0, 0, }, //  90
		{ 4, 16, 46, 76, 106, 170, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  91
		{ 4, 17, 47, 77, 107, 171, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  92
		{ 4, 18, 48, 78, 108, 172, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  93
		{ 4, 19, 49, 79, 109, 173, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  94
		{ 4, 20, 50, 80, 110, 174, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  95
		{ 4, 21, 51, 81, 111, 175, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244 }, //  96
		{ 0, 0, 0, 0, 0, 0, 0, }, //  100
		{ 0, 0, 0, 0, 0, 0, 0, }, //  100
		{ 0, 0, 0, 0, 0, 0, 0, }, //  100
		{ 0, 0, 0, 0, 0, 0, 0, }, //  100
...
bool CHARACTER::CanUseSkill(DWORD dwSkillVnum)
{
	...
	if (0 < GetSkillGroup())
	{
		if (SYSTEM_NOUVEAU_SKILL_7ET8 > 0)
		{
			const int SKILL_COUNT = 24;
			static const DWORD SkillList[JOB_MAX_NUM][SKILL_GROUP_MAX_NUM][SKILL_COUNT] =
			{
				{{1, 2,	3, 4, 5, 6, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244}, {16, 17, 18, 19, 20, 21, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244}},
				{{31, 32, 33, 34, 35, 36, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244}, {46, 47, 48, 49, 50, 51, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244}},
				{{61, 62, 63, 64, 65, 66, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244}, {76, 77, 78, 79, 80, 81, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244}},
				{{91, 92, 93, 94, 95, 96, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244}, {106, 107, 108, 109, 110, 111, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244}},
				{{170, 171, 172, 173, 174, 175, 221, 222, 223, 224, 225, 226, 227, 228, 229, 236, 237, 238, 239, 240, 241, 242, 243, 244},},
			};
