...
bool CMonarch::AddMoney(int Empire, long long Money)
{
	if (m_MonarchInfo.money[Empire] + Money > 9223372036854775807LLU)
		return true;

	m_MonarchInfo.money[Empire] += Money;

	long long Money64 = m_MonarchInfo.money[Empire];
...
bool CMonarch::DecMoney(int Empire, long long Money)
{
...
bool CMonarch::TakeMoney(int Empire, DWORD pid, long long Money)
{
