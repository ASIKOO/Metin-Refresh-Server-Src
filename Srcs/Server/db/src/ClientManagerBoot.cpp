...
{
	char query[2048];
	fprintf(stderr,"Herra Renaissance: Chargement du mob_proto de MySQL ");
	snprintf(query, sizeof(query),
...
"skill_vnum2,skill_level3,skill_vnum3,skill_level4,skill_vnum4 FROM mob_proto%s */
	...
	fprintf(stderr," Chargement terminé ! %d/%d Mobs lu.\r\n",size,vnumSet.size());
...
bool CClientManager::InitializeItemTable()
{
	...
	sort(m_vec_itemTable.begin(), m_vec_itemTable.end(), FCompareVnum());
            ...
            fprintf(stderr," Chargement terminé! %d Items lu.\r\n", m_vec_itemTable.size());
            return true;
